...
const Home = () => {
    ...
    return (
        <section className="section is-medium mt-6 ml-5 is-is-flex-direction-column is-justify-content-center is-align-items-baseline">
            <p className="is-size-3">Hello, </p>
            <h1 className="title is-size-1 mb-0"> I&apos;m  <span className="has-text-danger">Dalius</span></h1>
